...
exports.onCreateNotification = functions.firestore.document("/emergencies/{emergencieDoc}").onCreate(async (notifSnapshot, context) => {
    var tokens = notifSnapshot.data()['tokens'];
    var description = notifSnapshot.data()['description'];
    var place = notifSnapshot.data()['place'];
    var injured = notifSnapshot.data()['injured'];

    var title = `ZDARZENIE `;
    var body = `Opis:  ${description} by ${injured}`;
